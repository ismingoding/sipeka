      ...
      <aside class="col-md-3 mb-4">
        <div class="card shadow-sm rounded-3">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><a href="{{ route('riwayatpermohonan') }}" class="active-link"><i class="fa fa-folder-open me-2"></i>Riwayat Permohonan</a></li>
      ...
      <div class="col-md-9">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Riwayat Permohonan</h1>
          </div>
              ...
              <div class="col-lg-12">
                <div class="card mb-4">
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Riwayat Permohonan</h6>
                    <a class="btn btn-success" href="{{ route('layananadministratif') }}">
